...
def reset_AO0():
      ...
      AO0_OUT.write_one_sample(0.0)
      voltage_lbl.setText("0.0")
...
def send_AO0_1V():
      ...
      global AO0_OUT
      AO0_OUT = ni.stream_writers.AnalogSingleChannelWriter(AO0.out_stream)
      AO0_OUT.write_one_sample(1.0)
      voltage_lbl.setText("1.0")
...
def send_AO0_3V():
      ...
      global AO0_OUT
      AO0_OUT = ni.stream_writers.AnalogSingleChannelWriter(AO0.out_stream)
      AO0_OUT.write_one_sample(3.0)
      voltage_lbl.setText("3.0")
...
def send_AO0_5V():
      ...
      global AO0_OUT
      AO0_OUT = ni.stream_writers.AnalogSingleChannelWriter(AO0.out_stream)
      AO0_OUT.write_one_sample(5.0)
      voltage_lbl.setText("5.0")
      
      AO0.close()
      
def send_AO0_variable(voltage_amount):
      VOLTS = ni.constants.VoltageUnits.VOLTS
      AO0 = ni.Task()
      AO0.ao_channels.add_ao_voltage_chan("Dev1/ao0", "ao0 level", -10, 10, units = VOLTS)
      AO0.start()
      ...
      global AO0_OUT
      AO0_OUT = ni.stream_writers.AnalogSingleChannelWriter(AO0.out_stream)
      AO0_OUT.write_one_sample(voltage_box.get_value())
      voltage_lbl.setText(str(voltage_box.get_value()))
...
btn_reset.signal_clicked.connect(reset_AO0)
btn1v.signal_clicked.connect(send_AO0_1V)
btn2v.signal_clicked.connect(send_AO0_2V)
btn3v.signal_clicked.connect(send_AO0_3V)
btn5v.signal_clicked.connect(send_AO0_5V)
voltage_btn.signal_clicked.connect(send_AO0_variable)
